...
int qrvmc_java_set_jvm(JNIEnv* jenv)
{
...
static bool account_exists_fn(struct qrvmc_host_context* context, const qrvmc_address* address)
{
    const char java_method_name[] = "account_exists";
    const char java_method_signature[] = "(Lorg/theqrl/qrvmc/HostContext;[B)Z";

    assert(context != NULL);
    JNIEnv* jenv = attach();

    // get java class
    jclass host_class = (*jenv)->FindClass(jenv, "org/theqrl/qrvmc/Host");
    ...
    jbyteArray jaddress = CopyDataToJava(jenv, address, sizeof(struct qrvmc_address));
...
static qrvmc_bytes32 get_storage_fn(struct qrvmc_host_context* context,
                                   const qrvmc_address* address,
                                   const qrvmc_bytes32* key)
{
    const char java_method_name[] = "get_storage";
    const char java_method_signature[] = "(Lorg/theqrl/qrvmc/HostContext;[B[B)Ljava/nio/ByteBuffer;";
    ...
    // set java method params
    jbyteArray jaddress = CopyDataToJava(jenv, address, sizeof(struct qrvmc_address));
    jbyteArray jkey = CopyDataToJava(jenv, key, sizeof(struct qrvmc_bytes32));
    ...
    qrvmc_bytes32 result;
    CopyFromByteBuffer(jenv, jresult, &result, sizeof(qrvmc_bytes32));
    return result;
}

static enum qrvmc_storage_status set_storage_fn(struct qrvmc_host_context* context,
                                               const qrvmc_address* address,
                                               const qrvmc_bytes32* key,
                                               const qrvmc_bytes32* value)
{
    const char java_method_name[] = "set_storage";
    const char java_method_signature[] = "(Lorg/theqrl/qrvmc/HostContext;[B[B[B)I";
    ...
    jbyteArray jaddress = CopyDataToJava(jenv, address, sizeof(struct qrvmc_address));
    jbyteArray jkey = CopyDataToJava(jenv, key, sizeof(struct qrvmc_bytes32));
    jbyteArray jval = CopyDataToJava(jenv, value, sizeof(struct qrvmc_bytes32));

    // call java method
    jint jresult = (*jenv)->CallStaticIntMethod(jenv, host_class, method, (jobject)context,
                                                jaddress, jkey, jval);
    return (enum qrvmc_storage_status)jresult;
}

static qrvmc_uint256be get_balance_fn(struct qrvmc_host_context* context, const qrvmc_address* address)
{
    const char java_method_name[] = "get_balance";
    const char java_method_signature[] = "(Lorg/theqrl/qrvmc/HostContext;[B)Ljava/nio/ByteBuffer;";
    ...
    qrvmc_uint256be result;
    CopyFromByteBuffer(jenv, jresult, &result, sizeof(qrvmc_uint256be));
...
static size_t get_code_size_fn(struct qrvmc_host_context* context, const qrvmc_address* address)
{
    const char java_method_name[] = "get_code_size";
    const char java_method_signature[] = "(Lorg/theqrl/qrvmc/HostContext;[B)I";
...
static qrvmc_bytes32 get_code_hash_fn(struct qrvmc_host_context* context, const qrvmc_address* address)
{
...
static size_t copy_code_fn(struct qrvmc_host_context* context,
                           const qrvmc_address* address,
                           size_t code_offset,
                           uint8_t* buffer_data,
                           size_t buffer_size)
...
static struct qrvmc_result call_fn(struct qrvmc_host_context* context, const struct qrvmc_message* msg)
{
    const char java_method_name[] = "call";
    const char java_method_signature[] =
        "(Lorg/theqrl/qrvmc/HostContext;Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;";
    ...
    // set java method params
    jobject jmsg = (*jenv)->NewDirectByteBuffer(jenv, (void*)msg, sizeof(struct qrvmc_message));
    assert(jmsg != NULL);
    ...
    CopyFromByteBuffer(jenv, jresult, &result, sizeof(struct qrvmc_result));
    return result;
}

static struct qrvmc_tx_context get_tx_context_fn(struct qrvmc_host_context* context)
{
    const char java_method_name[] = "get_tx_context";
    const char java_method_signature[] = "(Lorg/theqrl/qrvmc/HostContext;)Ljava/nio/ByteBuffer;";
    ...
    struct qrvmc_tx_context result;
    CopyFromByteBuffer(jenv, jresult, &result, sizeof(struct qrvmc_tx_context));
    return result;
}

static qrvmc_bytes32 get_block_hash_fn(struct qrvmc_host_context* context, int64_t number)
{
    char java_method_name[] = "get_block_hash";
    char java_method_signature[] = "(Lorg/theqrl/qrvmc/HostContext;J)Ljava/nio/ByteBuffer;";
...
static void emit_log_fn(struct qrvmc_host_context* context,
                        const qrvmc_address* address,
                        const uint8_t* data,
                        size_t data_size,
                        ...
                        size_t topics_count)
{
    ...
    const char java_method_signature[] = "(Lorg/theqrl/qrvmc/HostContext;[B[BI[[BI)V";
    ...
    {
        jbyteArray jtopic = CopyDataToJava(jenv, topics[i].bytes, sizeof(struct qrvmc_bytes32));
...
static enum qrvmc_access_status access_account_fn(struct qrvmc_host_context* context,
                                                 const qrvmc_address* address)
{
    ...
    jint jresult =
        (*jenv)->CallStaticIntMethod(jenv, host_class, method, (jobject)context, jaddress);
    assert(jresult == QRVMC_ACCESS_COLD || jresult == QRVMC_ACCESS_WARM);
    return (enum qrvmc_access_status)jresult;
}

static enum qrvmc_access_status access_storage_fn(struct qrvmc_host_context* context,
                                                 const qrvmc_address* address,
                                                 const qrvmc_bytes32* key)
{
    const char java_method_name[] = "access_storage";
    const char java_method_signature[] = "(Lorg/theqrl/qrvmc/HostContext;[B[B)I";
...
{
    static const struct qrvmc_host_interface host = {

...
final class QrvmcTest {
  ...
  static {
    ...
    URL exampleVM = QrvmcTest.class.getClassLoader().getResource("libexample-vm." + extension);
  ...
  void testInitCloseDestroy() throws Exception {
    Assertions.assertDoesNotThrow(
        () -> {
          try (QrvmcVm vm = QrvmcVm.create(exampleVmPath)) {}
        });
  }
  ...
  @Test
  void testExecute_QRVMC_CREATE() throws Exception {
    try (QrvmcVm vm = QrvmcVm.create(exampleVmPath)) {
      HostContext context = new TestHostContext();
      int SHANGHAI = 11;
      int QRVMC_CREATE = 3;
      int kind = QRVMC_CREATE;
      char[] sender = "39bf71de1b7d7be3b51\\0".toCharArray();
      char[] recipient = "53cf77204eEef952e25\0".toCharArray();
      char[] value = "1\0".toCharArray();
      char[] inputData = "hello w\0".toCharArray();

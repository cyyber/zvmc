 ...
 * so we have to cast function pointers to the function types defined in QRVMC.
 ...
 */
const struct qrvmc_host_interface qrvmc_go_host = {
    (qrvmc_account_exists_fn)accountExists,
    (qrvmc_get_storage_fn)getStorage,
    (qrvmc_set_storage_fn)setStorage,
    (qrvmc_get_balance_fn)getBalance,
    (qrvmc_get_code_size_fn)getCodeSize,
    (qrvmc_get_code_hash_fn)getCodeHash,
    (qrvmc_copy_code_fn)copyCode,
    (qrvmc_call_fn)call,
    (qrvmc_get_tx_context_fn)getTxContext,
    (qrvmc_get_block_hash_fn)getBlockHash,
    (qrvmc_emit_log_fn)emitLog,
    (qrvmc_access_account_fn)accessAccount,
    (qrvmc_access_storage_fn)accessStorage,
};
